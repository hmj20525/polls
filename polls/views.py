...
# def detail(request, question_id):
#     try:
#         question = Question.objects.get(pk=question_id)     # 투표 진행중인 문항 / 유일하게 한 행을 가져올 때 get함수를 씀.
#     except Question.DoesNotExist:
#         raise Http404("진행 중인 투표가 없습니다.")
#     return render(request, 'polls/detail.html', {'question': question})     # 별 다른 에러가 없으면 return 반환.
# def detail(request, question_id):
